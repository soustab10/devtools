...
import type { Source, Location, SourceWithContent } from "../reducers/sources";
 ...
 *
 */
export function isJavaScript(source: SourceDetails, content: SourceContent["value"]) {
...
/*
export const getLineText = (asyncContent: SourceContent, line: number) => {
